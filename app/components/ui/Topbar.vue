...
<template>
  <header
    class="bg-[var(--winered-text)] dark:bg-[var(--winered-dark)] border-b border-red-200 dark:border-[var(--winered-medium)] h-16 flex items-center justify-between px-4 shadow-sm"
  >
    <!-- Left Side -->
    ...
    <div class="flex items-center gap-2">
      ...
      <div v-if="user" class="flex items-center gap-2 ml-2">
        <div
          class="w-8 h-8 rounded-full bg-[var(--winered-light)]/20 flex items-center justify-center"
        >
        ...
        <div class="hidden sm:block">
          <p
            class="text-sm font-medium text-gray-900 dark:text-[var(--winered-text)] truncate"
          >
            {{ user.name || "User" }}
          </p>
        </div>
