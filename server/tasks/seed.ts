  ...
  async run() {
    ...
    try {
      ...
      await db.insert(assignments).values({
        ...
        agentId: 'agent-101', // Mock agent ID
        teamId: 11, // Mock team ID
      })
      ...
      await db.insert(assignments).values({
        companyId: company2Id,
        status: 'Hinzugefügt Am',
        agentId: 'agent-102', // Mock agent ID
        teamId: 11, // Mock team ID
      })
      ...
      await db.insert(conversationNotes).values({
        companyId: company4Id,
        conversationHook: 'Innovatives Softwareunternehmen mit hohem Wachstumspotenzial.',
        researchResult:
      ...
      await db.insert(assignments).values({
        ...
        status: 'Hinzugefügt Am',
        agentId: 'agent-103',
        teamId: null, // Directly assigned to agent
      })
